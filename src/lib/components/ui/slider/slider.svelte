...
>
  {#snippet children({ thumbItems })}
    <span
      ...
      class={cn(
        "bg-input/90 bg-muted relative grow overflow-hidden rounded-full data-horizontal:h-2 data-horizontal:w-full data-horizontal:w-full data-vertical:h-full data-vertical:h-full data-vertical:w-2",
      )}
    >
