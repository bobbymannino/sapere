...
import TickIconComponent from "central-icons/IconCheckmark1Medium";
...
import CircleTickIconComponent from "central-icons/IconCircleCheck";
import CircleErrorIconComponent from "central-icons/IconCircleX";
...
import KeyIconComponent from "central-icons/IconKey1";
...
import TargetIconComponent from "central-icons/IconTarget1";
...
export const EnterIcon = asIcon(EnterIconComponent);
export const CircleErrorIcon = asIcon(CircleErrorIconComponent);
...
export const KeyIcon = asIcon(KeyIconComponent);
...
export const TargetIcon = asIcon(TargetIconComponent);
export const TickIcon = asIcon(TickIconComponent);
export const CircleTickIcon = asIcon(CircleTickIconComponent);
