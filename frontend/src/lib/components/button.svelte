<script lang="ts" module>
    ...
    export const buttonVariants = tv({
        slots: {
            button: "disabled:opacity-45 aria-disabled:pointer-events-none aria-disabled:opacity-45 disabled:pointer-events-none select-none inline-flex items-center justify-center font-medium focus-visible:ring-3 focus-visible:outline-none",
            icon: "animate-spin",
        },
        variants: {
            variant: {
